    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispensedMedications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispensedMedications_Medications_MedicationId",
                        column: x => x.MedicationId,
                        principalTable: "Medications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispensedMedications_MedicationId",
                table: "DispensedMedications",
                column: "MedicationId");

            migrationBuilder.CreateIndex(
                name: "IX_DispensedMedications_PrescriptionId",
                table: "DispensedMedications",
